            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card shadow">
                        ...
                        <div class="card-body"> 
                            <a href=" https://api.whatsapp.com/send?phone=6281269071846&text=Nama,nomer lapangan berikut bukti pembayaran" class="btn btn-success btn-block">{{ __('Kirim bukti perbayaran') }}</a>
                        </div>
                    </div>
                </div>
            </div>
